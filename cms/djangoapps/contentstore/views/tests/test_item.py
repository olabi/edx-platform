...
from contentstore.views.item import (
    create_xblock_info, ALWAYS, VisibilityState, _xblock_type_and_display_name, add_publishing_info
)
...
class TestXBlockInfo(ItemTest):
    ...
    def test_vertical_xblock_info(self):
        ...
        add_publishing_info(vertical, xblock_info)
...
class TestXBlockPublishingInfo(ItemTest):
    ...
    def test_staff_only_section(self):
        ...
        add_publishing_info(vertical, vertical_info)
