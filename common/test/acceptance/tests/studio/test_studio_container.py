...
class EditVisibilityModalTest(ContainerBase):
    ...
    VALIDATION_ERROR_MESSAGE = 'Error:\nThis xblock refers to deleted or invalid content groups.'
    ...
    def test_select_all_students_and_staff(self):
        """
    ...
    def test_select_dogs_and_cats(self):
        """
    ...
    def test_specific_content_groups(self):
        """
