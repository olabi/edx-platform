...
class SettingsMilestonesTest(StudioCourseTest):
    ...
    def test_prerequisite_course_save_successfully(self):
        ...
        select_ddl_by_value(self.settings_detail.pre_requisite_course, value=pre_requisite_course_id)
        ...
        self.settings_detail.refresh_page()
        self.assertTrue(is_ddl_value_selected(self.settings_detail.pre_requisite_course, value=pre_requisite_course_id))

        # now reset/update the pre requisite course to none
        select_ddl_by_value(self.settings_detail.pre_requisite_course, value='')

        # trigger the save changes button.
        self.settings_detail.save_changes()
        self.assertTrue('Your changes have been saved.' in self.settings_detail.browser.page_source)
        self.assertTrue(is_ddl_value_selected(self.settings_detail.pre_requisite_course, value=''))
